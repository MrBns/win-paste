...
// TODO: Implement macOS-specific gaps:
//   - Activation policy (setActivationPolicy(.accessory)) to hide from Dock
//   - always-on-top (NSWindowLevel.floating) may not behave correctly via window_manager
//   - setSkipTaskbar not fully supported on macOS; use activation policy instead
class WindowMacOS implements WindowPort, WindowListener {
