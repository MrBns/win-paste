...
// TODO: Implement full macOS clipboard support using NSPasteboard
class ClipboardMacOS implements ClipboardPort, ClipboardListener {
  ...
  Future<ClipboardItem?> readCurrentClipboard() async {
    // Basic text support only on macOS stub
  ...
  Future<void> writeToClipboard(ClipboardItem item) async {
    ...
    // Image/file writing not fully supported on macOS stub
  }
